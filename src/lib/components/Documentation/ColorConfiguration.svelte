<h3 class="text-xl font-semibold mt-8 text-white">Colors</h3>
<div class="p-6 rounded-md border mt-4 border-dark_border border-opacity-60">
	<p class="text-base font-medium text-muted text-opacity-60">
		<span class="font-semibold text-lg text-white">1. Override Colors</span>
		<br />
		For any change in colors : tailwind.config.ts
	</p>
	<div class="py-4 px-5 rounded-md bg-dark_grey mt-8">
		<p class="text-sm text-gray-400 flex flex-col gap-2">
...
<div class="p-6 rounded-md border mt-4 border-dark_border border-opacity-60">
	<p class="text-base font-medium text-muted text-opacity-60">
		<span class="font-semibold text-lg text-white">2. Override Theme Colors</span>
		<br />
