...
<div class="sm:px-10 px-4">
	...
	<div class="mt-6">
		<label for="sell-amount" class="text-white text-15 mb-2 block">Amount</label>
		<div class="relative">
			<input
				id="sell-amount"
				type="number"
	...
	<div class="mt-6">
		<label for="sell-total" class="text-white text-15 mb-2 block">Total</label>
		<div class="relative">
			<input
				id="sell-total"
				type="text"
